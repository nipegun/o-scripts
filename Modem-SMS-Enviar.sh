...
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/o-scripts/master/Modem-SMS-Enviar.sh | sed 's/xxxxxxxxx/NumeroDeMovilAlQueEnviar/g' | sed 's/xxx/TextoAEnviar/g'| sh
# ----------
