...
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/o-scripts/refs/heads/master/SoftInst/LXC-Contenedor-Crear-6-Alpine-boa.sh | sh

cCarpetaLXC='/mnt/nvme/lxc'

cNombreDelContenedor='alpine-boa'
cAlpineVers='3.24'
cAlpineArch='arm64'
cIPv4Contenedor='10.10.4.6'
cMaskCIDR='24'
...
#curl -sL https://raw.githubusercontent.com/nipegun/bunch-of-aigents/refs/heads/main/deploy/install-update-reinstall-alpine.sh | sh
  # Apagar el contenedor
    lxc-stop -n "$cNombreDelContenedor"
    
# Mostrar mensaje para fin de la instalación
  echo ''
  echo '  Instalación de BoA, finalizada.'
  echo '    La web está en:'
