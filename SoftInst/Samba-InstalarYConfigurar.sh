...
# ----------
# Script de NiPeGun para instalar y configurar Samba en OpenWrt
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/o-scripts/refs/heads/master/SoftInst/Samba-InstalarYConfigurar.sh | sed 's-usuariox-NuevoNombreDeUsuario-g' | sh 
# ----------
