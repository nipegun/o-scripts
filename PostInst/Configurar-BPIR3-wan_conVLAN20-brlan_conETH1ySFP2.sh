...
# ----------
# Script de NiPeGun para configurar un router OpenWrt para conectarse a una ONT con Internet en la VLAN 20
#
# Este script asigna los puertos eth1 (el sfp1 de la izquierda) y el puerto sfp2 al puente LAN (br-lan).
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/o-scripts/master/PostInst/Configurar-BPIR3-wan_conVLAN20-brlan_conETH1ySFP2.sh | sh
# ----------
...
# Notificar inicio de ejecución del script
  echo ""
  echo -e "${vColorAzulClaro}  Configurando la BPI-R3 para conectarse a una ONT con Internet en la VLAN 20...${vFinColor}"
  echo ""
