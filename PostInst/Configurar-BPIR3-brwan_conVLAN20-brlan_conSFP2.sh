...
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/o-scripts/master/PostInst/Configurar-BPIR3-brwan_conVLAN20-brlan_conSFP2.sh | sh
# ----------
...
# /etc/config/network
  ...
  echo "  option device 'br-wan.20'"                                         >> /etc/config/network
